%
% For use in the verification of the sine-wave PWM array generated by the microcontroller.
% The on-chip SPWM implementation found in spwm_arraygen.c
%

clc
clear
pkg load signal % This line only necessary with GNU Octave
